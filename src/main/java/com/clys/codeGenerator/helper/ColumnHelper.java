...
public class ColumnHelper {
	...
	public static List<ColumnDefinition> descTableColumnDefinition(DBHelper dbHelper,String table){
		List<Map<String, Object>> resultList = dbHelper.descTable(table);
		return covertColumnDefinition(resultList);
	}
